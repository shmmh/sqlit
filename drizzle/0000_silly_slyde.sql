DO $$ BEGIN
 CREATE TYPE "public"."expense_category" AS ENUM('utilities', 'food', 'transportation', 'entertainment', 'other');
EXCEPTION
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "items" ADD CONSTRAINT "items_expense_id_expenses_id_fk" FOREIGN KEY ("expense_id") REFERENCES "public"."expenses"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
